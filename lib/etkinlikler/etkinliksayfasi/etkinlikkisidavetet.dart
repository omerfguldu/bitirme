        ...
        builder: (BuildContext buildContext,
          ...
          if (snapshot.data != null) {
            ...
            return Padding(
              ...
              child: Center(child: Text("Takip Ettiğiniz Kişi Yok.",style: TextStyle(fontSize: 20.0.spByWidth),)),
            );
          }
    ...
    return StreamBuilder(
        ...
        builder: (BuildContext buildContext,
          ...
          if (snapshot.data != null) {
            ...
            return Padding(
              padding:  EdgeInsets.only(top: 30.0.h),
              child: Center(child: Text("Takipçiniz Yok.",style: TextStyle(fontSize: 20.0.spByWidth),)),
            );
          }
          return snapshot.connectionState == ConnectionState.waiting
              ? Center(
