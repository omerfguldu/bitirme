...
class FavorilerimCard extends StatefulWidget {
  ...
  @override
  _FavorilerimCardState createState() => _FavorilerimCardState();
}

FirestoreDBService _firestoreDBService = locator<FirestoreDBService>();


class _FavorilerimCardState extends State<FavorilerimCard> with AutomaticKeepAliveClientMixin {
  @override
                  ...
                  child: Padding(
                    ...
                    child: Container(
                        child: Column(
                            ...
                            children: [
                              Padding(
                                padding: EdgeInsets.only(left: 6.0.w,right: 20.0.w),
