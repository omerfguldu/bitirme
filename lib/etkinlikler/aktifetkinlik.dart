...
class EventBloc{
  ...
  EventBloc(){
    ...
    var myEvents = FirebaseFirestore.instance
        .collection('etkinlik')
        .where("userId", isEqualTo: FirebaseAuth.instance.currentUser.uid)
        .where("tarih", isGreaterThan: DateTime.now())
        .orderBy('tarih', descending: false)
        .snapshots();
    myEvents.listen((event) {
      _eventSink.add(event.docs);
    });
    ...
    //         .orderBy('tarih', descending: false)
    //         .get();
    //     print("addind collection refereance to sink katilim");
...
class AktifEtkinlik2 extends StatefulWidget {
  @override
  _AktifEtkinlik2State createState() => _AktifEtkinlik2State();
}

class _AktifEtkinlik2State extends State<AktifEtkinlik2> {
