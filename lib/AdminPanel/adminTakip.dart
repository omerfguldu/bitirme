...
class AdminTakip extends StatefulWidget {
  final Map<String, dynamic> card;

  const AdminTakip({Key key, this.card}) : super(key: key);
  @override
  _AdminTakipState createState() => _AdminTakipState();
}
...
class _AdminTakipState extends State<AdminTakip>  with SingleTickerProviderStateMixin {
        ...
        builder: (BuildContext buildContext,
          ...
          if (snapshot.data == null) {
            ...
            return StreamBuilder<QuerySnapshot>(
              stream: FirebaseFirestore.instance.collection('users').doc(widget.card['userId']).collection("takipEttiklerim").snapshots(),
