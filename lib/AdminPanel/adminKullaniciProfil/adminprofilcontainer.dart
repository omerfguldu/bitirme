...
class AdminKullaniciContainer extends StatefulWidget {
  final Map<String, dynamic> card;

  AdminKullaniciContainer({this.card});
  @override
  _AdminKullaniciContainerState createState() => _AdminKullaniciContainerState();
}
FirestoreDBService _firestoreDBService = locator<FirestoreDBService>();

class _AdminKullaniciContainerState extends State<AdminKullaniciContainer> {
                                  ...
                                  Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Row(
                                          children: [
                                            Text( widget.card['hesaptipi'].toString(),style: TextStyle(fontSize: 13.0.w),),
