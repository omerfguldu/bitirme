...
import 'package:etkinlik_kafasi/AdminPanel/uyeninProfiSayfasi.dart';
...
class YoneticiDetay extends StatefulWidget {
  final DocumentSnapshot card;
  final DocumentSnapshot cardYonetici;
  YoneticiDetay({this.card,this.cardYonetici});
  @override
  _YoneticiDetayState createState() => _YoneticiDetayState();
}
FirestoreDBService _firestoreDBService = locator<FirestoreDBService>();

class _YoneticiDetayState extends State<YoneticiDetay>
  ...
  void initState() {
    ...
    print("card: "+widget.card.data().toString());
          ...
          actions: <Widget>[
            Padding(
              ...
              child: IconButton(
                ...
                onPressed: (){
                  print("car gelen:"+widget.cardYonetici.data().toString());
                  Navigator.push(context,
                    MaterialPageRoute(builder: (context) => Yetkilendirme(card: widget.card.data(),cardYonetici: widget.cardYonetici,)),
                  );
                },
              ),
            ),
