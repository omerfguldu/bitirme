...
class TemsilciDetay extends StatefulWidget {
  final DocumentSnapshot card;
  final DocumentSnapshot cardYonetici;
  TemsilciDetay({this.card,this.cardYonetici});
  @override
  _TemsilciDetayState createState() => _TemsilciDetayState();
}
FirestoreDBService _firestoreDBService = locator<FirestoreDBService>();

class _TemsilciDetayState extends State<TemsilciDetay>
