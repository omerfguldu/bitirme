...
class YorumYapAlertDialogEtkinlik extends StatefulWidget {
  final String ad;
  ...
  @override
  _YorumYapAlertDialogEtkinlikState createState() => _YorumYapAlertDialogEtkinlikState();
}
class _YorumYapAlertDialogEtkinlikState extends State<YorumYapAlertDialogEtkinlik>with AutomaticKeepAliveClientMixin {
        ...
        children: [
          ...
          Column(
            ...
            children: [
              ...
              Text(widget.ad,style: TextStyle(fontSize: 16.0.spByWidth),),
              StreamBuilder<QuerySnapshot>(
                  ...
                  builder: (BuildContext context,
                    ...
                    snapshot2.data.docs.toString() == "[]" ? null : snapshot2.data.docs[0]['onay'] == true ? geldi=true : geldi=false;
                    return  snapshot2.data.docs.toString() == "[]" ?
                    OylamaEmojileriEtkinlik(userid:_userModel.user.userId ,etid: widget.etid.toString(),karsiuser: widget.karsiuserid.toString(),carid: widget.carid,)
                    ...
                    OylamaEmojileriEtkinlik(userid:_userModel.user.userId ,etid: widget.etid.toString(),karsiuser: widget.karsiuserid,carid: widget.carid,);
                  }),
          ...
          children: [
            ...
            Padding(
              ...
              child: MyButton(text: "Gönder", butonColor: Renkler.onayButonColor,
                ...
                onPressed: geldi ? null : widget.Pressed,
              ),
            ),
          ],
        ),
