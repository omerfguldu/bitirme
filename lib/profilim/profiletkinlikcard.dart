...
import 'package:etkinlik_kafasi/profilim/profiletkinlikdetay.dart';
...
class ProfilEtkinlikCard extends StatefulWidget {
  ...
  @override
  _ProfilEtkinlikCardState createState() => _ProfilEtkinlikCardState();
}
FirestoreDBService _firestoreDBService = locator<FirestoreDBService>();

class _ProfilEtkinlikCardState extends State<ProfilEtkinlikCard> {
  @override
    ...
    return GestureDetector(
      onTap: () {
        Navigator.of(context).push(
          MaterialPageRoute(
            builder: (c) => ProfilEtkinlikDetay(etkinlikBilgileri: widget.etkinlikBilgileri,card: widget.card,),
          ),
        );
      },
      child: Container(
