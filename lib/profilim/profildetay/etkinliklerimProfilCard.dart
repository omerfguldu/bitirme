...
import 'package:etkinlik_kafasi/profilim/profildetay/etkinliklerimProfilDetay.dart';
...
class EtkinliklerimProfilCard extends StatefulWidget {
  ...
  @override
  _EtkinliklerimProfilCardState createState() => _EtkinliklerimProfilCardState();
}
FirestoreDBService _firestoreDBService = locator<FirestoreDBService>();

class _EtkinliklerimProfilCardState extends State<EtkinliklerimProfilCard> {
  @override
    ...
    return GestureDetector(
      onTap: () {
        Navigator.of(context).push(
          MaterialPageRoute(
            builder: (c) => EtkinlikProfilDetay(etkinlikBilgileri: widget.etkinlikBilgileri,card: widget.card,),
          ),
        );
      },
      child: Container(
