...
class EtkinlikProfilDetay extends StatefulWidget {
  final EtkinlikModel etkinlikBilgileri;
  final DocumentSnapshot card;

  const EtkinlikProfilDetay({Key key, this.etkinlikBilgileri,this.card}) : super(key: key);

  @override
  _EtkinlikProfilDetayState createState() => _EtkinlikProfilDetayState();
}

class _EtkinlikProfilDetayState extends State<EtkinlikProfilDetay> {
                    ...
                    children: [
                                ...
                                onPressed: (){
                                  if(_userModel.user.uyelikTipi=="standart"){
                                    if(_userModel.user.acilanetkinliksayim>3){
                                      ...
                                      _firestoreDBService.etkinlikKatilmaIstegiButonu(widget.card, _userModel.user.userId,_userModel.user.adsoyad);
                                    }
                      ...
                      Padding(
                        ...
                        child: MyButton(text: "Eşleşmeler",
                          ...
                          onPressed: (){
                            Navigator.of(context).push(MaterialPageRoute(builder: (context) => EtkinliklerimEslesmeSayfasi(card: widget.card,)));
                          },
                        ),
                      ),
