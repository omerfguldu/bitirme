...
import 'package:etkinlik_kafasi/profilim/profildetay/userEtkinliklerimDetay.dart';
...
class UserProfilimEtkinlikCard extends StatefulWidget {
  ...
  @override
  _UserProfilimEtkinlikCardState createState() => _UserProfilimEtkinlikCardState();
}
FirestoreDBService _firestoreDBService = locator<FirestoreDBService>();

class _UserProfilimEtkinlikCardState extends State<UserProfilimEtkinlikCard> {
  @override
    ...
    return GestureDetector(
      onTap: () {
        Navigator.of(context).push(
          MaterialPageRoute(
            builder: (c) => userEtkinlikDetay(etkinlikBilgileri: widget.etkinlikBilgileri,card: widget.card,),
          ),
        );
      },
      child: Container(
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              Container(
                                width: 256.0.w / 8,
                                child: Text(widget.kalanGun.abs() < 10 ? NumberFormat("0").format(widget.kalanGun.abs()) :  NumberFormat("00").format(widget.kalanGun.abs()),
                                    style: TextStyle(
