...
class Takipci extends StatefulWidget {
  final DocumentSnapshot card;

  const Takipci({Key key, this.card}) : super(key: key);

  @override
  _TakipciState createState() => _TakipciState();
}
...
class _TakipciState extends State<Takipci> with SingleTickerProviderStateMixin {
